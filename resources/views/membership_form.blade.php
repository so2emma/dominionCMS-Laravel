    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="border border-secondary shadow">
                <h3 class="text-center py-3">Membership data sheet <p><a href="{{ route('login') }}">Admin Login</a></p></h3>
                ...
                <form class="row g-3  m-auto p-3" action="/storemembershipForm" method="post">
                    ...
                    <div class="col-12">
                        ...
                        <input type="radio" name="gender" value="Male" class="radio" id="male" <?php if (old('gender') == 'Male') {echo 'checked="checked"';} ?>> Male
                        <input type="radio" name="gender" value="Female" class="radio" id="female" <?php if(old('gender')== "Female") { echo 'checked="checked"'; } ?>>Female
                    ...
                    <div class="col-12">
                        ...
                        <input type="date" value="{{ old('weddingAnniversary') }}" class="form-control" name="weddingAnniversary" id="">
                    ...
                    <div class="col-12">
                        ...
                        <input type="radio" name="bornAgain" value="Born Again" class="radio" id="Born Again" <?php if (old('bornAgain') == 'Born Again') {echo 'checked="checked"';} ?>>Yes
                        <input type="radio" name="bornAgain" value="Not Born Again" class="radio" id="female" <?php if(old('bornAgain')== "Not Born Again") { echo 'checked="checked"'; } ?>>No
                    ...
                    <div class="col-12">
                        ...
                        <input type="date" value="{{ old('salvationDate') }}" class="form-control" name="salvationDate" id="">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" value="{{ old('previousChurch') }}"  class="form-control" name="previousChurch" id="">
                    ...
                    <div class="col-12">
                        ...
                        <input type="radio" name="membershipClass" value="completed" class="radio" <?php if (old('membershipClass') == 'completed') {echo 'checked="checked"';} ?>>Yes
                        <input type="radio" name="membershipClass" value="Yet to complete" class="radio"  <?php if(old('membershipClass')== "Yet to complete") { echo 'checked="checked"'; } ?>>No
                    ...
                    <div class="col-12">
                        ...
                        <input type="date" value="{{ old('membershipCompletion') }}" class="form-control" name="membershipCompletion" id="">
                    ...
                    <div class="col-12">
                        ...
                        <input type="radio" name="workerStatus" value="Worker" class="radio" <?php if (old('workerStatus') == 'Worker') {echo 'checked="checked"';} ?>>Yes
                        <input type="radio" name="workerStatus" value="Not a worker" class="radio"  <?php if(old('workerStatus')== "Not a worker") { echo 'checked="checked"'; } ?>>No
                    ...
                    <div class="col-12">
                        ...
                        <input type="radio" name="houseFellowshipStatus" value="house fellowshipper" class="radio" <?php if (old('houseFellowshipStatus') == 'house fellowshipper') {echo 'checked="checked"';} ?>>Yes
                        <input type="radio" name="houseFellowshipStatus" value="No fellowship" class="radio"  <?php if(old('houseFellowshipStatus')== "No fellowship") { echo 'checked="checked"'; } ?>>No
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" value="{{ old('fellowshipLocation') }}" class="form-control" name="fellowshipLocation" id="">
                    ...
                    <div class="col-12">
                        ...
                        <input type="date" value="{{ old('dateJoined') }}" class="form-control" name="dateJoined" id="">
