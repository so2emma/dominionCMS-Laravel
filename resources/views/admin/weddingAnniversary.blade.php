            ...
            <div class="container ">
                <div class="row">
                    <div class="col-md-8 m-auto">
                        <form action="/admin/weddingAnniversary" method="get">
                            <div class="mb-3 form-group">
                                <label class="lead" for="">Wedding Anniversary Which Month: </label>
                                <select class="form-select" name="weddingAnniversary" aria-label="Default select example">
        ...
        <table class="table">
            ...
            <tbody>
              ...
              <div class="alert alert-danger">
                    <p>No Wedding Anniversary for this month </p>
              </div>
              @endunless
            </tbody>
          </table>
